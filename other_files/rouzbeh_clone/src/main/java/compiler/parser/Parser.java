...
public class Parser {
    ...
    public Parser(Lexical lexical, CodeGen CodeWrite, InputStream nptFile){
        this(lexical,CodeWrite,nptFile, false);
    }


    public Parser(Lexical lexical, CodeGen CodeWrite, InputStream nptFile, boolean debug) {
